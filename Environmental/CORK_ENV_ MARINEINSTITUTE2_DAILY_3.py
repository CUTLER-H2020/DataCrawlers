# -*- coding utf-8 -*-
""" -This Crawler+Scraper requests the URL (Marine institute Ocean Forecast observations) and fetches the HTML source of the target page"""
...
class marineOceanForecast():
    ...
    def __init__(self):
        ...
        homePage = "http://erddap2.marine.ie/erddap/griddap/IMI_NEATL.htmlTable?"
        ...
        finalUrl = (homePage + "sea_surface_height"+duration+",sea_surface_temperature"+duration+",sea_bottom_temperature"+duration+",sea_surface_salinity"+duration+",sea_bottom_salinity"+duration+",sea_surface_x_velocity"+duration+",sea_surface_y_velocity"+duration+",sea_bottom_x_velocity"+duration+",sea_bottom_y_velocity"+duration+",mixed_layer_depth"+duration)
    def readHtml(self):
